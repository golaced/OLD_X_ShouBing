...
u8 temp;
	...
	else 		if(NRF24L01_RXDATA[1]==66)	//APP
	{  
		

			state_drone = (float)((vs16)(NRF24L01_RXDATA[4]<<8)|NRF24L01_RXDATA[5]);
			drone_pos[2] = (float)((vs16)(NRF24L01_RXDATA[6]<<8)|NRF24L01_RXDATA[7]);
			tar_pos[0] = (float)((vs16)(NRF24L01_RXDATA[8]<<8)|NRF24L01_RXDATA[9]);
			tar_pos[1] = (float)((vs16)(NRF24L01_RXDATA[10]<<8)|NRF24L01_RXDATA[11]);
			drone_pos[0] = (float)((vs16)(NRF24L01_RXDATA[12]<<8)|NRF24L01_RXDATA[13]);
			drone_pos[1] = (float)((vs16)(NRF24L01_RXDATA[14]<<8)|NRF24L01_RXDATA[15]);
			qr_pos[0] = (float)((vs16)(NRF24L01_RXDATA[16]<<8)|NRF24L01_RXDATA[17]);
			qr_pos[1] = (float)((vs16)(NRF24L01_RXDATA[18]<<8)|NRF24L01_RXDATA[19]);
			yaw_gimbal = (float)((vs16)(NRF24L01_RXDATA[20]<<8)|NRF24L01_RXDATA[21]);
		 // DEBUG[23]= (float)((vs16)(NRF24L01_RXDATA[22]<<8)|NRF24L01_RXDATA[23]);
			//DEBUG[24]= (float)((vs16)(NRF24L01_RXDATA[24]<<8)|NRF24L01_RXDATA[25]);
			//DEBUG[25]= (float)((vs16)(NRF24L01_RXDATA[28]<<8)|NRF24L01_RXDATA[27]);
		  //DEBUG[26]= (float)((vs16)(NRF24L01_RXDATA[30]<<8)|NRF24L01_RXDATA[29]);
...
void NRF_Send_ARMED(void)//????
{
	...
	NRF24L01_TXDATA[21] =(SEL_KEY[3]<<3)|(SEL_KEY[2]<<2)|(SEL_KEY[1]<<1)|SEL_KEY[0];
	NRF24L01_TXDATA[22] =(MODE_KEY[7]<<7)|(MODE_KEY[6]<<6)|(MODE_KEY[5]<<5)|(MODE_KEY[4]<<4)|(MODE_KEY[3]<<3)|(MODE_KEY[2]<<2)|(MODE_KEY[1]<<1)|MODE_KEY[0];
	_temp=(int)(Yaw*100);
